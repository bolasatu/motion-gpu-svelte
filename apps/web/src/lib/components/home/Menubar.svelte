...
>
  <div class="border border-border bg-white rounded-lg">
    <div
      class="relative flex items-center justify-between gap-3 px-3 py-2 sm:px-4"
    >
      <a
        href={resolve(homeRoute)}
        class="inline-flex items-center gap-1 px-2 py-2 text-sm tracking-tight text-foreground transition-colors hover:text-foreground duration-150 ease-out"
      >
        <span
      ...
      >
        <a
          href="#home"
          class="inline-flex items-center gap-2 px-2 py-2 text-sm tracking-tight text-foreground/70 transition-colors hover:text-foreground duration-150 ease-out"
        >
          Home
        </a>
        <a
      ...
      <button
        type="button"
        class="inline-flex size-10 items-center justify-center gap-2 text-sm whitespace-nowrap text-foreground transition-colors hover:bg-background duration-150 ease-out sm:hidden"
...
{#if mobileOpen}
  ...
  <div
    ...
    tabindex="-1"
    class="fixed top-20 left-1/2 z-50 grid w-[min(92vw,30rem)] -translate-x-1/2 gap-2 border border-border bg-white p-3 rounded-lg sm:hidden"

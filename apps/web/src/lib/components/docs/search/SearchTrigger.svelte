...
<button
	type="button"
	class={cn(
		'group inset-shadow relative flex h-9 w-full items-center gap-2 rounded-lg border border-border bg-background-inset px-3 py-1.5 text-sm text-foreground/45 transition-[color] duration-150 ease-out hover:text-foreground-muted',
		className
	)}

...
<div class="mt-auto">
	<div class="flex flex-col gap-1 text-sm">
		<button
			...
			class="group/option flex items-center gap-2 overflow-hidden rounded-sm px-3 py-1.5 text-left text-foreground-muted transition-colors duration-150 ease-out hover:bg-background-inset hover:text-foreground"
		>
		...
		<a
			class="group/option flex items-center gap-2 rounded-sm px-3 py-1.5 text-left text-foreground-muted transition-colors duration-150 ease-out hover:bg-background-inset hover:text-foreground"
			href={githubUrl}
			target="_blank"
			rel="noreferrer"
		>
